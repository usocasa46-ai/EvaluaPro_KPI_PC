...
export const STORAGE_KEYS = {
  ...
  globalSettings: "system_global_settings",
  companySettings: "company_settings",
  availableSystemModules: "system_available_modules",
  customCompanyModules: "custom_company_modules",
